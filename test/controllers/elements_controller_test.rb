...
class ElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create element" do
    assert_difference("Element.count") do
      post elements_url, params: { element: { atomic_mass: @element.atomic_mass, atomic_number: @element.atomic_number, name: @element.name, symbol: @element.symbol } }
    end
  ...
  test "should update element" do
    patch element_url(@element), params: { element: { atomic_mass: @element.atomic_mass, atomic_number: @element.atomic_number, name: @element.name, symbol: @element.symbol } }
